...
@UI: {
 headerInfo: { typeName: 'Viaje', typeNamePlural: 'Viajes', title: { type: #STANDARD, value: 'TravelID' } } }

@Search.searchable: true

define root view entity ZC_VGCTRAV_M_01 
    as projection on ZI_VGCTRAV_M_01 {
 @UI.facet: [ { id:              'Travel',
                purpose:         #STANDARD,
